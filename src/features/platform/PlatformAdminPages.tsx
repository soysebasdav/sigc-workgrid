...
const platformNav: Array<{ to: string; label: string; icon: LucideIcon; permission: string; end?: boolean }> = [
  ...
  { to: '/superadmin/commercial', label: 'Gestión comercial', icon: BadgeDollarSign, permission: 'platform.commercial.view' },
  { to: '/superadmin/plans', label: 'Planes y complementos', icon: Layers3, permission: 'platform.plans.view' },
  { to: '/superadmin/billing', label: 'Facturación', icon: Receipt, permission: 'platform.billing.view' },
  { to: '/superadmin/onboarding', label: 'Onboarding', icon: ClipboardCheck, permission: 'platform.onboarding.view' },
  { to: '/superadmin/integrations', label: 'Integraciones', icon: Network, permission: 'platform.integrations.view' },
  { to: '/superadmin/knowledge', label: 'Conocimiento', icon: BookOpen, permission: 'platform.knowledge.view' },
  { to: '/superadmin/reliability', label: 'Salud y disponibilidad', icon: HeartPulse, permission: 'platform.health.view' },
  { to: '/superadmin/incidents', label: 'Incidentes', icon: ShieldAlert, permission: 'platform.incidents.view' },
  { to: '/superadmin/privacy', label: 'Privacidad', icon: FileKey2, permission: 'platform.privacy.view' },
  { to: '/superadmin/governance', label: 'Gobierno y continuidad', icon: Languages, permission: 'platform.retention.view' },
  { to: '/superadmin/capacity', label: 'Capacidad', icon: Gauge, permission: 'platform.capacity.view' },
